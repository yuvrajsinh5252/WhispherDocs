...
export default function Messages({ fileId }: MessageProps) {
    ...
    return (
        <div className="m-2 max-sm:m-0 max-sm:mb-1 p-2 overflow-y-scroll scrollbar-thumb-blue scrollbar-track-blue-lighter scrollbar-w-2 rounded-md flex flex-col-reverse gap-2 h-full">
