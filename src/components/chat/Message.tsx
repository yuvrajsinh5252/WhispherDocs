    ...
    return (
      ...
      >
        {!message.isUserMessage && !isNextMessageSamePerson && (
          <div className="flex-shrink-0 mr-2 animate-in slide-in-from-left duration-300">
        ...
        <div
          className={cn(
            "max-w-[85%] sm:max-w-[75%] rounded-2xl px-3.5 py-2.5 sm:px-5 sm:py-3 transition-all hover:shadow-lg",
            {
              ...
              "bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800/90 dark:to-gray-700/80 text-gray-800 dark:text-gray-100 backdrop-blur-sm shadow-md border border-indigo-100 dark:border-gray-600/50 hover:border-indigo-200 dark:hover:border-gray-500/50":
                !message.isUserMessage,
              "rounded-br-none":
                message.isUserMessage && !isNextMessageSamePerson,
              "rounded-bl-none":
        ...
        >
          <div
            className={cn(
              ...
              message.isUserMessage &&
                "prose-headings:text-white prose-a:text-blue-100 prose-strong:text-indigo-100"
            )}
          >
        ...
        {message.isUserMessage && !isNextMessageSamePerson && (
          <div className="flex-shrink-0 ml-2 animate-in slide-in-from-right duration-300">
