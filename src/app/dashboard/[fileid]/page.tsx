...
export default async function page({ params }: PageProps) {
    ...
    return (
        <div className="flex h-[calc(100vh-4rem)] max-sm:h-[calc(100vh-3.4rem)] p-5 max-sm:p-1">
            <div className="flex max-sm:flex-col  justify-between w-full gap-4 max-sm:gap-1">
                ...
                <div className="max-sm:w-full border-2 min-h-[4rem] rounded-lg w-9/12 border-zinc-300 dark:border-gray-600">
